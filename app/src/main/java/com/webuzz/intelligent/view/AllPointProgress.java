...
import com.webuzz.intelligent.utils.DisplayUtil;


public class AllPointProgress extends View {
	...
	public AllPointProgress(Context context) {
		this(context, null);
	}

	public AllPointProgress(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public AllPointProgress(Context context, AttributeSet attrs, int defStyleAttr) {
