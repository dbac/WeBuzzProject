...
public class FalanProgress extends View {
	...
	public FalanProgress(Context context) {
		this(context, null);
	}

	public FalanProgress(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public FalanProgress(Context context, AttributeSet attrs, int defStyleAttr) {
