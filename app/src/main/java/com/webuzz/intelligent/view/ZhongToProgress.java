...
public class ZhongToProgress extends View {
    ...
    public ZhongToProgress(Context context) {
        this(context, null);
    }

    public ZhongToProgress(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ZhongToProgress(Context context, AttributeSet attrs, int defStyleAttr) {
